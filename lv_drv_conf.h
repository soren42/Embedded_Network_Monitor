 ...
 *
 * LP Network Monitoring - Raspberry Pi 5 with Goodix Capacitive TouchScreen
 * Display: Linux framebuffer (/dev/fb0)
 * Input:   Linux evdev (/dev/input/event0)
 */
...
#  define EVDEV_NAME   "/dev/input/event0"        /*Goodix Capacitive TouchScreen*/
